...
export function computeRelativeImprovement(current: number | undefined, baseline: number | undefined): number | undefined {
...
export function parseAutoresearchArgs(rawArgs: string, defaultIterations: number): { goal: string; iterations: number } {
...
export function parseBenchmarkArgs(rawArgs: string, defaultRuns = 3): { goal: string; runs: number } {
